                ...
                <div class="product-details"><!--product-details-->
                    ...
                    <div class="col-sm-7">
                        <div class="product-information"><!--/product-information-->
                            ...
                            <?php if ($product->new): ?>
                                <?= \yii\helpers\Html::img("@web/images/home/new.png", ['alt' => 'Новинка', 'class' => ['newarrival']]) ?>
                            <?php endif; ?>
                            <?php if ($product->sale): ?>
                                <?= \yii\helpers\Html::img("@web/images/home/sale.png", ['alt' => 'Розпродажа', 'class' => ['newarrival']]) ?>
                            <?php endif; ?>
                            <h2><?= $product->name ?></h2>
                            <p>Web ID: 1089772</p>
